...
class PagosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pago" do
    assert_difference('Pago.count') do
      post pagos_url, params: { pago: { efectivo: @pago.efectivo, monto: @pago.monto, numero_transferencia: @pago.numero_transferencia } }
    end
  ...
  test "should update pago" do
    patch pago_url(@pago), params: { pago: { efectivo: @pago.efectivo, monto: @pago.monto, numero_transferencia: @pago.numero_transferencia } }
