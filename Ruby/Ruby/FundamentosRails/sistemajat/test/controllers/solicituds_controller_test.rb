...
class SolicitudsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create solicitud" do
    assert_difference('Solicitud.count') do
      post solicituds_url, params: { solicitud: { descripcion: @solicitud.descripcion, destino: @solicitud.destino, hora: @solicitud.hora, monto_sugerido: @solicitud.monto_sugerido, oferta_driver: @solicitud.oferta_driver, origen: @solicitud.origen, titulo: @solicitud.titulo } }
    end
  ...
  test "should update solicitud" do
    patch solicitud_url(@solicitud), params: { solicitud: { descripcion: @solicitud.descripcion, destino: @solicitud.destino, hora: @solicitud.hora, monto_sugerido: @solicitud.monto_sugerido, oferta_driver: @solicitud.oferta_driver, origen: @solicitud.origen, titulo: @solicitud.titulo } }
